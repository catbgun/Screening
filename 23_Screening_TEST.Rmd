...
ggplot(topP6z, aes(x=compound, y=log(plotting)+10, colour=Level, shape=Level))+
  geom_point(size=3.5)+
  theme_bw()+
...
ggsave("Whale groups.png", whales, width = 10, height = 8)
...
pack <- ggplot(topP6z, aes(x=compound, y=log(plotting)+10, colour=Packaging))+
  geom_point(size=3)+
  theme_bw()+
 ...
 ggsave("packaing.png", pack, width = 10, height = 8)
```
...
ggplot(jl, aes(x=compound, y=log(plotting)+10, colour=Category, shape=Category))+
  geom_point(size=4)+
  theme_bw()+
  theme(axis.text.x = element_text(angle = 90, size=10, colour="black"),
        axis.text.y = element_text(size=11, colour="black"),
...
ggsave("Whale species.png", w_species, width = 10, height = 7)
```
...
as <- ggplot(topP10, aes(x=compound, y=log(plotting)+10, colour=Maturity, shape=Maturity))+
  geom_point(size=4)+
  theme_bw()+
  theme(axis.text.x = element_text(angle = 90, size=10, colour="black"),
        axis.text.y = element_text(size=11, colour="black"),
...
ggsave("age and sex.png", as, width = 10, height = 7)
...
ggplot(topP7x, aes(x=compound, y=(plotting), shape=Sample.type, colour= Sample.type))+
  geom_point(size=4.5)+
  theme_bw()+
  theme(axis.text.x = element_text(angle = 90, size=12, colour="black"),
        axis.text.y = element_text(size=11, colour="black"),
...
ggsave("Whale tissue.png", w_tissue, width = 10, height = 7)
...
ggplot(shark1, aes(x=fct_rev(compound), y=(plotting), colour=Category, shape=Category))+
  geom_point(size=4)+
  theme_bw()+
   theme(axis.text.x = element_text(angle = 90, size=12, colour="black"),
        axis.text.y = element_text(size=11, colour="black"),
...
ggsave("SHARKY.png", SHARKY, width = 10, height = 7)
...
part32 <- mutate(part32, new = value / Fett)
...
fat_whale <- ggplot(part34, aes(x=fct_rev(compound), y=log(new)+10, colour=Level, shape=Level))+
  geom_point(size=3.5)+
  theme_bw()+
  theme(axis.text.x = element_text(angle = 90, size=11, colour="black"),
        axis.text.y = element_text(size=11, colour="black"),
...
ggsave("whales_fat.png", fat_whale, width = 10, height = 7)
```
...
w_species_fat <- ggplot(part34x, aes(x=(compound), y=log(new)+10, colour=Category, shape=Category))+
  geom_point(size=4)+
  theme_bw()+
  theme(axis.text.x = element_text(angle = 90, size=10, colour="black"),
        axis.text.y = element_text(size=11, colour="black"),
...
ggsave("Whale species_FAT.png", w_species_fat, width = 10, height = 7)
```
...
w_tissue_fat <- ggplot(part34y, aes(x=compound, y=log(new)+10, shape=Sample.type, colour= Sample.type))+
  geom_point(size=4.5)+
  theme_bw()+
  theme(axis.text.x = element_text(angle = 90, size=12, colour="black"),
        axis.text.y = element_text(size=11, colour="black"),
...
ggsave("Whale tissue_FAT.png", w_tissue_fat, width = 10, height = 7)
```
...
as_FAT <- ggplot(part34x, aes(x=compound, y=log(new)+10, colour=Maturity, shape=Maturity))+
  geom_point(size=4)+
  theme_bw()+
  theme(axis.text.x = element_text(angle = 90, size=10, colour="black"),
        axis.text.y = element_text(size=11, colour="black"),
...
ggsave("age and sex_FAT.png", as_FAT, width = 10, height = 7)
...
pnec <- subset(newtablexx, compound %in% c("PF201", "DABPA", "UV310", "UV1164","BEMT","BPAP2","TBPHT","B-2ETF","CUMIN","CBZL","BDPME","TMPID","DPMPE","BZBA","FEFAC","MABT","DMPSHEN","DTBMMP","CB28","CB52","CB101","CB118","CB38","CB153","CB180","BDE17","BDE28","BDE47","BDE49","BDE66","BDE71","BDE77","BDE85","BDE99","BDE100","BDE119","BDE126","BDE138","BDE153","BDE154","BDE156","BDE183","BDE184","BDE191","BDE196","BDE197","BDE202","BDE206","BDE207","SCCP","MCCP","LCCP","TBECHB","TBECHG","BATE","PBEB" ,"QCB","HCB","DDC_DBF","DDC_ANT","DDC_PS","DDC_PA","Cr","Fe","Ni","Cu","Zn","As","Se","Ag","Cd","Sn","Sb","Pb","Hg","TTBPP","DEHPO","DOCDPA","DPGUAN","UV1130","KRYFIO","ETPPBR","ADNP","GBLA","BZDSA","UV329","SG3","UV360","UV234","DTBPPO","UV384","BAC_C12","BAC_C14","BAC_C16","ATAC_C12","ATAC_C14","AAC_C16","ATAC_C18","UV327","OCTOC","PFNA","PFDA","PFUNDA","PFDODA","PFTRDA","PFHXS","PFOS","PFBSA","NMEFBSA","PFOSA"))
...
# short and compound
dx <- read.table("PNECs Screening 23.txt", header=TRUE, sep="\t", na.string=c(""))
...
write.csv(dx4, "C:/Users/CBG/OneDrive - NIVA/1 Projects/Screening/Screening_R/Screening/Output/240826_TEST_pnec_2.csv", row.names=FALSE)

```

```{r PNEC plot}
ggplot(dx5, aes(y=fct_rev(compound), x=value2+10, xmin = Min+10, xmax=Max+10, colour = sample_category))+ 
  geom_linerange(aes(colour = sample_category, alpha=1), linewidth=1.5, position = position_dodge2(width = 0.7))+
  geom_point(aes(x=(limit+10), fill = sample_category),  size=5, shape=18, position = position_dodge2(width = 0.7))+
...
ggsave("pnec23.png", pnecopp, width = 7, height = 20)
