...
ggplot(road_water2, aes(y=as.numeric(value), x=compound, fill=Medium_id))+
  geom_boxplot()+
  theme_bw()+
...
#SLUDGE
ggplot(road_slud, aes(y=as.numeric(value), x=compound, colour=Comment_location))+
...
#AIR
ggplot(road_air, aes(y=as.numeric(value), x=compound, fill=Comment_condition))+
  geom_boxplot()+
  theme_bw()+
  theme(axis.text.x = element_text(angle = 90, size=12, colour="black"),
        axis.text.y = element_text(size=11, colour="black"),
