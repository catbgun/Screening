...
ggpaired(sht7, cond1 = "mean_valueU", cond2 = "mean_valueT",
...
ggplot(dx3qqqx, aes(y=fct_rev(compound), x=value2, xmin = Min2, xmax=Max2, colour = sample_category))+ 
  geom_linerange(size=2.8, aes(colour = sample_category, alpha=1), position = position_dodge2(width = 0.7))+
  ...
  scale_color_manual(values = c("#00BFC4", "#D55E00"),
...
ggsave("pnec.png", pnec, width = 8, height = 7.3)
